...
const getAllMemes = async () => {
  return await axios
    .get(`${process.env.REACT_APP_BACKEND_BASE_URL}/memes`)
...
const addMeme = async (data) => {
  return await axios
    .post(`${process.env.REACT_APP_BACKEND_BASE_URL}/memes`, data, {
...
const getMemeById = async (id) => {
  return await axios
    .get(`${process.env.REACT_APP_BACKEND_BASE_URL}/memes/${id}`)
    .then((response) => response.data);
};
...
const updateMeme = async (id, data) => {
  return await axios
    .patch(`${process.env.REACT_APP_BACKEND_BASE_URL}/memes/${id}`, data, {
      headers: { "Content-Type": "application/json" },
    })
