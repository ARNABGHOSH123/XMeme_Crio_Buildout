...
import {getAllMemes} from '../../queries/queries';
...
function CircularProgressWithLabel(props) {
    return (
        <Dialog aria-labelledby="simple-dialog-title" style={{textAlign: "center"}} TransitionComponent={Transition} keepMounted open={true}>
...
function CircularStatic() {
    ...
    function setNewProgress(prevProgress){
    ...
    const NoMemesLoaded = () => {
        ...
        return (
            <div className="row justify-content-center">
                <h4 style={{marginTop: "20vh"}}>No memes found.Check your network connection</h4>
            </div>
        )
    }
